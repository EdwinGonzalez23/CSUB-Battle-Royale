...
class Ship {
	...
	public:
		Ship() {
			VecZero(dir);
			pos[0] = (Flt)(gl3.xres/2);
			pos[1] = (Flt)(gl3.yres/2);
			pos[2] = 0.0f;
			VecZero(vel);
			angle = 0.0;
	...
	public:
		Game() {
			...
			for (int j=0; j<1; j++) { //Change num asteroid
				...
				a->pos[0] = (Flt)(rand() % gl3.xres);
				a->pos[1] = (Flt)(rand() % gl3.yres);
				a->pos[2] = 0.0f;
				a->angle = 0.0;
...
//
// void menuSound(){
//         play_sound(gl3.mgSound);
//         sleep(1);
//         play_sound(gl3.sfSound);
// }
//
// void beginFade(){
//         fadeOutBegin=1;
...
//                 colors-=1;
// 		genBH(gl3.bhTexture, 1200,1200,350);
// 		genBH(gl3.bhTexture, 2000,1600,350);
// 		genBH(gl3.bhTexture, 1800,1900,350);
// 		genBH(gl3.bhTexture, 1300,2000,350);
// 		genBH(gl3.bhTexture, 1500,2500,350);
//         }
//         if(colors==0){
//                 faded =1;
//                 toggleMenu();
